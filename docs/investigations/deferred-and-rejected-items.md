...
| **Upstream issue: `reentrant` attr cannot force the soft stack** | READY TO FILE | Independent issue body written; **posting is user-triggered**. | User triggers the upstream post. | [issue body](../upstream-reentrant-soft-stack-issue.md) |
