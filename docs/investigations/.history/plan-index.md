...
| [2026-06-29](https://github.com/wbniv/llvm-mos-65816/commit/a33bd8f) | docs(plan-index): batch-refresh the recent demo cluster's commit SHAs |
| [2026-06-29](https://github.com/wbniv/llvm-mos-65816/commit/14575af) | docs(plan-index): add the #12 CORDIC Rotator row (close committed-plan drift) |
| [2026-06-29](https://github.com/wbniv/llvm-mos-65816/commit/2397e74) | docs(snes): #4 Buddhabrot close-out + dedupe burning-ship rows |
...
fab41e7	deleted	1
fab41e7	files	1
fab41e7	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
47b1a2c	deleted	0
47b1a2c	files	1
47b1a2c	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
4ded087	author	Will Norris
4ded087	added	2
4ded087	deleted	0
4ded087	files	1
4ded087	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
d055629	author	Will Norris
d055629	added	2
d055629	deleted	0
d055629	files	1
d055629	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
eecfd2f	deleted	0
eecfd2f	files	1
eecfd2f	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
8473d5b	deleted	0
8473d5b	files	1
8473d5b	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
fcc842e	deleted	1
fcc842e	files	1
fcc842e	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
f5e8262	deleted	0
f5e8262	files	1
f5e8262	body	Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>
...
b9e7b8c	deleted	0
b9e7b8c	files	1
b9e7b8c	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
4c7c9de	deleted	0
4c7c9de	files	1
4c7c9de	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
b4e238a	author	Will Norris
b4e238a	added	2
b4e238a	deleted	1
b4e238a	files	1
b4e238a	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
9b1f137	author	Will Norris
9b1f137	added	2
9b1f137	deleted	0
9b1f137	files	1
9b1f137	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
48f1c90	author	Will Norris
48f1c90	added	2
48f1c90	deleted	2
48f1c90	files	1
48f1c90	body	#21's plan committed (cd3663a) since the last refresh; fill its row's commit\ncell. No demo rows remain _uncommitted_. Footer note updated.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
a33bd8f	author	Will Norris
a33bd8f	added	11
a33bd8f	deleted	10
a33bd8f	files	1
a33bd8f	body	Fill the real creation-commit SHA for the nine recent demo rows that were\nstuck at _uncommitted_ (their plans were committed, but the rows added by the\nparallel demo agents never recorded the SHA): #18 maze 9f3d71e, #7 doom-fire\n32a4114, #10 fourier 070328f, #5 life 30333e0, #9 harmonograph 70e1840,\n#15 raycaster 579ad86, #1 julia 0cabf2d, #4 buddhabrot 95ae613, #3 burning-ship\n8e6f647 — and re-sort them into creation-commit order (oldest first), per the\nindex's stated ordering rule. Only #21 Soft-Float Mandelbrot stays _uncommitted_\n(its plan file is genuinely not committed yet). Footer note updated.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
14575af	author	Will Norris
14575af	added	2
14575af	deleted	0
14575af	files	1
14575af	body	The CORDIC demo plan (34fd3ad) was committed without its plan-index row — the\npre-commit audit kept flagging the drift. Add the row in creation-commit order\n(after c09912a 06-28 15:47, before the uncommitted recent-demo cluster): the\nmultiply-free shift-add member with the inverted disasm gate (asserts the\nABSENCE of mul/div libcalls), gate cordic_gate_crc 0x4D41, live at\nbiohack.net/snes/cordic/. Bump the footer refresh line (181 plans).\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
2397e74	author	Will Norris
2397e74	added	1
2397e74	deleted	1
2397e74	files	1
2397e74	body	Wire #4 Buddhabrot into the registry now that it's built, verified, and live:\nTODO entry (done, gate 0x7C31, biohack.net/snes/buddhabrot/), Taskfile\nbuddha/buddha-grid/buddha-play tasks, dev/run.sh help, plan-index row.\n\nAlso dedupe the two duplicate "#3 Burning Ship" rows a concurrent agent's\n`git add -A` sweep left in TODO.md and plan-index.md (kept the fuller text).\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
669c44f	deleted	1
669c44f	files	1
669c44f	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
d9d7f82	deleted	1
d9d7f82	files	1
d9d7f82	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>
...
2c07c95	deleted	1
2c07c95	files	1
2c07c95	body	Co-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_01J79PZm5LMmiJGxQH9kHcuQ
