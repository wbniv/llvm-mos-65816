...
r=Path('/work');b=r/'build/selectiondag-inlineasm-fix';build=r/'build/newton-postra-build';log=r/'docs/defects/evidence/2026-09-25-selectiondag-inlineasm/candidate-build.log'
