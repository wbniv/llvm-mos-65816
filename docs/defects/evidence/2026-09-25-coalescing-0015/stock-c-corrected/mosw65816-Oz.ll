...
63:                                               ; preds = %56, %62, %59
  ...
  %65 = sub nsw i16 %3, %57
  store i16 %65, ptr %0, align 1, !tbaa !7
  %66 = sub nsw i16 %4, %64
  store i16 %66, ptr %1, align 1, !tbaa !7
  br label %67
...
attributes #0 = { minsize mustprogress nofree noinline norecurse nosync nounwind optsize willreturn memory(argmem: readwrite) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="mosw65816" }
