...
67:                                               ; preds = %66, %62
  ...
  %69 = sub nsw i16 %3, %59
  store i16 %69, ptr %0, align 1, !tbaa !2
  %70 = sub nsw i16 %4, %68
  store i16 %70, ptr %1, align 1, !tbaa !2
  br label %71
...
attributes #0 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="mosw65816" "target-features"="+mos-a16,+mos-xy16" }
