# 1 "/home/will/llvm-mos-65816/.scratch/carry-scheduling/docs/defects/evidence/2026-09-26-mos-carry-scheduling/p_sum.c.txt"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/will/llvm-mos-65816/.scratch/carry-scheduling/docs/defects/evidence/2026-09-26-mos-carry-scheduling/p_sum.c.txt" 2
...
# 2 "/home/will/llvm-mos-65816/.scratch/carry-scheduling/docs/defects/evidence/2026-09-26-mos-carry-scheduling/p_sum.c.txt" 2

extern const __attribute__((address_space(2))) uint16_t tbl[];
volatile int32_t i0=100,i1=50000,i2=90000;
volatile uint32_t out;
void f(void){uint32_t a=0;a+=tbl[i0];a+=tbl[i1];a+=tbl[i2];out=a;}
