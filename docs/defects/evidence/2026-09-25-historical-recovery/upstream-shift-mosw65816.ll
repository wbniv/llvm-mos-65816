...
32:                                               ; preds = %0, %25
  ...
  store volatile i64 %33, ptr @bitboard64_opaque, align 8, !tbaa !12
  %35 = load volatile i64, ptr @bitboard64_opaque, align 8, !tbaa !12
  ...
  %39 = load volatile i64, ptr @bitboard64_opaque, align 8, !tbaa !12
  %40 = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %39, i1 true)
  store i64 %38, ptr @bitboard64_state.0, align 1, !tbaa !7
  %41 = or i64 %34, %38
  store i64 %41, ptr @bitboard64_state.1, align 1, !tbaa !10
...
attributes #0 = { nofree norecurse nosync nounwind optsize memory(readwrite, target_mem: none) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="mosw65816" }
attributes #1 = { nofree noinline norecurse nosync nounwind optsize memory(readwrite, argmem: none, target_mem: none) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="mosw65816" }
