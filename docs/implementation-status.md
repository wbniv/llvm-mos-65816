...
The five-address-space model is partly landed — **AS3 packed-24** (the 3-byte far-ptr storage form) is
**built + verified + landed (`0006`, 2026-06-21/22, incl. the static-init table reloc fix)**; only AS4
zero-bank + the upstream PR remain. **Far function pointers (a)** are now **FULLY DONE + LANDED (2026-06-21)** —
