...
2. **#320 far function pointers (a)** — IN PROGRESS: the indirect-call mechanism is built + verified
   ...
   legalization (L1/L2 done; L3 `SelectImm` + Gap A/B remain), (2) clang F2 `far` attr + CodeGen,
