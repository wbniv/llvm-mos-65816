...
Review 0031 separately after 0030. These are local results, not a
...
| [#584 — Fix non-GPR immediate loads in mos-late-opt](https://github.com/llvm-mos/llvm-mos/pull/584) | `7f4c37de6219` | Simplified guard published in the September revision bundle. Await maintainer review. | Pass / cancelled / pass |
...
- **Copy-destination reuse — follow-up prepared September 22.**
  ...
  c-torture corpus, `.text` −2,530 bytes over the 435 changed compilations, MOS
  CodeGen and MC pass, MAME + bsnes-jg corpus gate. Publish after 0030; unposted.
