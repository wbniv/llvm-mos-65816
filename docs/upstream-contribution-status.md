...
- **✅ POSTED (campaign Wave 1, items 2+3, 2026-07-26): Wave 1 COMPLETE** —
  ...
  row 16, gated on a maintainer response to #578). **Wave 3 (user judgment): 2 possible PRs** — `0011`/`0015`,
  latent stock bugs currently reachable only via the fork's a16/xy16; both require reachability review.
  Former candidate `0012` is **retired and must not be posted**.
