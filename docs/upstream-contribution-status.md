...
- ~~**MC-layer `cop` mnemonic (assembler gap, found by demo #140, 2026-08-04).**~~ ✅ **POSTED
  ...
  (`$02` is `NXT` on the 65EL02, pinned by a negative RUN line). MC suite 39/40 (lone failure
  pre-existing). Body pre-flighted: source link verified 200 post-push; a16/xy16 wording de-forked
