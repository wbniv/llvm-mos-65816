...
- **✅ POSTED (campaign Wave 1, item 1, 2026-07-26): 🎉 MERGED upstream 2026-08-29** — `0016`
  G_SCMP/G_UCMP — issue [**#576**](https://github.com/llvm-mos/llvm-mos/issues/576) (closed by the
  merge) + PR [**#577**](https://github.com/llvm-mos/llvm-mos/pull/577)
  (`wbniv:mos-scmp-ucmp-legalize` @ `62dd8731dccb` — rebased and review-addressed 2026-08-28;
  `CHECK-NOT: jsr` + s32-result case; fix + `scmp-ucmp.ll`, `Fixes #576`, live-demo links in body;
  merge commit `e528e8ea`). Fork patch `patches/llvm-mos/0016-mos-scmp-ucmp-legalize.patch` stays
  until the vendor pin (`8be0546128a5`, 2026-07-13, unmoved) is bumped past the merge.
- **✅ POSTED (campaign Wave 1, items 2+3, 2026-07-26): Wave 1 COMPLETE** —
  `0010` coalesce-rotate-Ac = [**PR #578**](https://github.com/llvm-mos/llvm-mos/pull/578)
  (`wbniv:mos-coalesce-rotate-ac`, still open), DWARF step-6 = [**PR #579**](https://github.com/llvm-mos/llvm-mos/pull/579)
  (`wbniv:mos-dwarf-65816-test-docs`, **🎉 MERGED upstream 2026-08-22** — test/docs-only, no fork
  patch to retire). **Wave 2 is next: 3 issues** (+ the llvm-mos-sdk
