...
- **Hygiene: 0 leftover fork branches** — `revert-540-…` (a stale revert of merged #540) was **deleted by
  the user 2026-06-23** on explicit request. Standing policy unchanged: keep fork branches until merged
  upstream; **do not auto-propose deletion** (delete only on explicit request).
