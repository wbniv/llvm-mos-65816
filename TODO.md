...
- [ ] **#321 native s16 — 16-bit comparison follow-ups** — **SCOPED 2026-06-21** ([plan](docs/plans/2026-06-21-321-native-s16-comparison-followups.md)): compare surface measured ~complete — everything native except the optimal byte-wise register-resident equality; residual = one measurement-gated candidate (**ordering-as-value branchless carry-tail**, distinct from the rejected EQ rol-tail because `cmp` yields the carry directly) + an audit close-out. (unsigned ordering, ~~(a) equality `== !=`~~,
...
- [verify] **2026-06-21-321-native-s16-comparison-followups** — Verification section present but no PASS recorded — run + record the steps. _from [2026-06-21-321-native-s16-comparison-followups.md](docs/plans/2026-06-21-321-native-s16-comparison-followups.md)_  <!-- fp:c91b9765672261df -->
