...
- [verify] **2026-06-21-321-ordering-value-branchless-banked** — Verification section present but no PASS recorded — run + record the steps. _from [2026-06-21-321-ordering-value-branchless-banked.md](docs/plans/2026-06-21-321-ordering-value-branchless-banked.md)_  <!-- fp:5f242fd76b40e2f7 -->
