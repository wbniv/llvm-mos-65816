...
- [ ] **(triage)** Scope (c) is **analysis only** — no content acquisition; no fetch path is being added. — _from [2026-08-01-svx2-60fps-ring-refill.md](docs/plans/2026-08-01-svx2-60fps-ring-refill.md)_  <!-- fp:3a823bd1aa076872 -->
- [ ] **(triage)** Reel-side integration is deliberately not attempted: `examples/snes/snes-video-reel.c`, — _from [2026-08-01-svx2-60fps-ring-refill.md](docs/plans/2026-08-01-svx2-60fps-ring-refill.md)_  <!-- fp:838c40fb50c90609 -->
