...
asm(".text\n"
    ...
    "  sta $2122\n"
    "19:\n"
    /* The automatic-reader version of this path silently stopped accepting
       input in both native and browser bsnes. Keep the proven serial latch in
       this latency-sensitive NMI until that integration is understood. */
    "  lda #$01\n"
    "  sta $4016\n"
    "  lda #$00\n"
    "  sta $4016\n"
