 ...
 *
 * controller_poll() reads pad 1 from the completed automatic latch; held/pressed/released expose the
...
static inline void controller_poll(Controller *c) { c->prev = c->cur; c->cur = snes_read_pad1_auto(); }
