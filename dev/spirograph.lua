-- dev/spirograph.lua — MAME autoboot: let the spirograph bloom, snapshot the real PPU output, and
-- assert the curve-math proof (corpus_result) matches the host oracle. MAME's video:snapshot() needs a
