-- dev/doom-fire.lua — MAME autoboot: run the Doom-fire demo, snapshot PPU output, assert corpus_result.
-- Inputs (env vars):
--   SHOT_ADDR  program-space address of corpus_result  (e.g. 0x7E0200)
--   SHOT_WANT  expected hash from host oracle           (e.g. 0x3C59)
