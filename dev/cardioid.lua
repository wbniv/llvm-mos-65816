-- dev/cardioid.lua — MAME autoboot: run the cardioid times-table demo, snapshot the PPU output,
-- assert corpus_result matches the host oracle.  Inputs via env:
--   SHOT_ADDR  program-space addr of corpus_result (e.g. 0x7E1234)
--   SHOT_WANT  expected hash (host reference, e.g. 0x076E)
...
local WANT = num("SHOT_WANT", 0x523B)
