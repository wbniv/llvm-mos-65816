...
# #320 follow-up (a-F): sizeof(far*)==4 — far ptr stored in a struct, needs +mos-a16.
build_rom far_sizeof mos-snes.cfg -Xclang -target-feature -Xclang +mos-a16
...
xassert "$BUILD/far_sizeof.sfc" "$BUILD/far_sizeof.map" corpus_result 0xD1 # sizeof(far*)==4 — far ptr in a struct field, deref'd, adjacent tag intact
