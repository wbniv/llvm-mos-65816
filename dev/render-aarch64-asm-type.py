#!/usr/bin/env python3
"""Render the AArch64 defect report with collapsed session and compiler transcripts."""
...
source = root / 'docs/investigations/2026-09-25-aarch64-inlineasm-unknown-type.md'
transcript = root / 'docs/transcripts/2026-09-25-aarch64-asm-type.md'
...
<title>AArch64 inline-assembly unknown types — patch 0058</title>
<style>
