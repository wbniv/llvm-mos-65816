#!/usr/bin/env python3
"""Render the coalescing revalidation report with collapsed session and compiler transcripts."""
...
source = root / 'docs/investigations/2026-09-25-coalescing-0015-revalidation.md'
transcript = root / 'docs/transcripts/2026-09-25-coalescing-0015.md'
evidence = root / 'docs/defects/evidence/2026-09-25-coalescing-0015'
logs = '\n'.join((evidence / name).read_text() for name in
                 ['baseline-closure.log', 'candidate-closure.log'])
page = '''<!doctype html>
<html lang="en"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Coalescing guard 0015 — revalidation</title>
<style>
