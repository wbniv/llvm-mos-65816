...
echo "==> [gen] worktree @ pristine + commit 0001 + 0002 (+0003) as baseline"
...
git -C "$WT_GEN" add -A
git "${GIT_ID[@]}" -C "$WT_GEN" commit -q -m "0001+0002(+0003) baseline"
...
echo "==> [verify] apply 0001 + 0002 (+0003) + new 0004 to a fresh pristine worktree"
